        ...
        <div className="service-row bg">
          ...
          <div className="service-col">
            ...
            <div className="service-description">
              <p>
                At Stackmentalist, we epitomize the convergence of innovation
                ...
                dedicated to delivering top-notch software solutions across the
                globe.
                <br />
                <br />
                ...
                industry. As a leader in technology exploring, Stackmentalist is
                committed to delivering high-quality software across the globe.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="service-col">
            ...
            <div id="second-desc" className="service-description">
              <p>
                ...
                targeted, ensuring you find the right talent efficiently.
                <br />
                <br />
                Harnessing advanced online and cloud-based technologies
                alongside proven recruiting strategies, we deliver a blend of
                high-tech and high-touch solutions tailored to your business
                needs.{" "}
              </p>
            </div>
          </div>
          ...
          <div id="third-box" className="service-col">
            ...
            <div id="third-desc" className="service-description">
              <p>
                ...
                results firsthand. <br />
                <br />
                What sets us apart? We're not your average firm. We're a dynamic
                team brimming with fresh ideas and vibrant personalities.
                Renowned for our commitment to perfection, professionalism, and
                excellence, we've made a mark in the public relations and
                marketing industry, helping brands and businesses flourish both
        ...
        <div className="service-row no-bg">
          <div className="service-col">
            ...
            <div id="four-desc" className="service-description">
              <p>
                Experience technology education redefined at Stackmentalist. As
                pioneers in IT training, we are renowned for our results-driven
                approach and commitment to excellence. Our focus remains
                unwaveringly on delivering top-tier training and fostering
                innovative thinking among our students. Driven by a profound
                passion for technology, we are dedicated to revolutionizing the
                pedagogy of tech education. Our mission is to impart a deep
                understanding of technology's core principles, empowering
                individuals to grasp its true essence.<br></br>
                <br></br>
                At Stackmentalist, we're continuously pushing boundaries,
                exploring new domains of knowledge, and refining our training
                methodologies to ensure our students stay ahead of the curve.
                Join us and embark on a transformative journey in technology
                education.{" "}
              </p>
            </div>
          </div>
